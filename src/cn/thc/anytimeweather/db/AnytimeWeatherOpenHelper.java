package cn.thc.anytimeweather.db;
...
public class AnytimeWeatherOpenHelper extends SQLiteOpenHelper {
	...
	public static final String CREATE_COUNTY = "create table Country (" + "id integer primary key autoincrement, "
			+ "county_name text, " + "county_code text, " + "city_id integer)";

	public AnytimeWeatherOpenHelper(Context context, String name, CursorFactory factory, int version) {
